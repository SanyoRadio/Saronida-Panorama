...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'sarodata/saro_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'sarodata/saro_messages_','.xml');
}
    ...
    if(mapsApiLength > 0){
        ...
        if (mapsApiLength > 1 && mapApiOrder[1]) {
            ...
            if (mapsApiLength > 2 && mapApiOrder[2]) {
                ...
                var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript3], false);
                var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
                var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
                var mapstractionScriptCoreLayer3 = new ktools.Script("maps_mapstraction_core_layer3", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/"+mapApiOrder[2][3]+refreshIE, [mapstractionScriptCore], false);
                var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCoreLayer3], false);
                var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
            } else {
                if(mapsApiLength > 2){
                    var tmp_counter = mapLoadedCounter.item(pluginName) - 1;
                    mapLoadedCounter.update(pluginName, tmp_counter);
                }
                var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript2], false);
                var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
                var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
                var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCore], false);
                var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
            }
        } else {
            if(mapsApiLength > 1){
            ...
            var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript], false);
            var mapstractionScriptBase = new ktools.Script("maps_mapstraction_base", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.basemap.js", [mapstractionScript], false);
            var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScriptBase], false);
            var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCore], false);
        }

        var kolorMapScript = null;
        if (useGoogleLabelsClass) {
            var googleLabelsScript = new ktools.Script("maps_google_labels", crossDomainTargetUrl+"sarodata/graphics/KolorMap/lib/mxn.googlev3.core.labels.js", [mapstractionScriptCoreLayer1], false);
            kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"sarodata/graphics/KolorMap/js/KolorMap.min.js", [googleLabelsScript], true);
        } else {
            kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"sarodata/graphics/KolorMap/js/KolorMap.min.js", [mapstractionScriptCoreLayer1], true);
        }
        mapPlugin.addScript(kolorMapScript);

        var kolorMapCSS = new ktools.CssStyle("kolormapCSS", crossDomainTargetUrl+"sarodata/graphics/KolorMap/js/kolorMap.css");
...
function initKolorMapOnReady(pluginName, defaultMapLayer, mapAreaDiv) {
    ...
    kolorMap.setGraphicsUrl(crossDomainTargetUrl+"sarodata/graphics/"+pluginName.toLowerCase()+"/");
...
function addKolorArea(pPlugID)
{
	...
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"sarodata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"sarodata/graphics/KolorArea/KolorArea.min.js", [], true);
...
function addKolorBox(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"sarodata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"sarodata/graphics/KolorBox/KolorBox.min.js", [], true);
